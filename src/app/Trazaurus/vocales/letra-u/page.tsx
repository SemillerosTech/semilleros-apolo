    ...
    <>
      ...
      <section className="p-6 max-w-6xl mx-auto text-gray-800">
        ...
        <article className="mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>
              ...
              reconocida por todos, es importante platicar todas sus variantes.
              Además, trabajar sobre temas como la cercanía, el cariño, el
              afecto y cómo se demuestran.
            </li>
            <li>
        ...
        <article className="mb-8">
          ...
          <p className="mb-2">
            Para los niños es importante reconocer a sus seres cercanos, qué los
            hace sentirse unidos y con quiénes tienen confianza. Todo el bloque
            de vocales ha tenido diferentes actividades o lecturas, por lo que
            es importante que puedan repetir la elaboración de alguna de ellas
            para reforzar el aprendizaje de las vocales y su reconocimiento y
            discriminación, facilitando así la combinación con las consonantes.
          </p>
          <p>
