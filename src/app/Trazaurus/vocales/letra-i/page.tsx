        ...
        <section className="p-6 max-w-6xl mx-auto text-gray-800">
          ...
          <article className="mb-8">
            ...
            <p className="mb-2">
              ...
              reconocer la letra <strong>&quot;I&quot;</strong>, puedan
              compartir si se sienten impacientes o inquietos, y cómo enfrentan
              o resuelven esa sensación. Compartir sus experiencias puede ser
              una manera de aprender de los demás y descubrir otras estrategias
          ...
          <article className="mb-8">
            ...
            <p className="mb-2">
              ...
              impaciencia y apoyarlos con juegos o actividades que pueden
              realizar mientras esperan, algunas sugerencias son:
            </p>
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                ¿Cuántas cosas lleva la persona de enfrente en el carrito?
              </li>
              <li>
          ...
          <article className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                Baruch, R. (2019).{" "}
                <em>La Oruga muy impaciente. Cuento para niños.</em> Scholastic
                en Español.
              </li>
              <li>
                Quintin, N. (2023).{" "}
                <em>
                  El árbol de la paciencia: libros para pequeños exploradores
                  del siglo XXI.
                </em>{" "}
