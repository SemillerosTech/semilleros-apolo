        ...
        <section className="p-6 max-w-6xl mx-auto text-gray-800">
          ...
          <article className="mb-8">
            ...
            <p className="mb-2">
              ...
              sobre cada uno de los sentidos y cómo los utilizamos, incluyendo
              los olores y sabores agradables y desagradables, les permite
              aprender a aceptar las diferencias como algo natural y a apreciar
              los pequeños detalles que los rodean.
            </p>
            <p>
              Este ejercicio les ayuda a observar detalles como el color de los
              ojos y el tamaño de las orejas, además de desarrollar la
              percepción de otros sentidos como el gusto, el olfato y el tacto.
            </p>
          </article>
          ...
          <article className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                ...
                tamaño, color de piel, color de ojos, capacidad de la vista o
                del oído, y que en la calle pueda diferenciar que todos son
                diferentes.
              </li>
              <li>
                ...
                acompañando a la vocal. Aunque no sepa cuál es, se estimula el
                que entienda que las letras van acompañando unas a otras.
              </li>
            </ul>
          </article>
